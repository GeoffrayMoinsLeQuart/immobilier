...
export const _mock = {
  ...
  // Text
  courseTitle: (index: number) => _projectTitle[index],
  projectProfitability: (index: number) => _projectProfitability[index],
  projectTotalCost: (index: number) => _projectTotalCost[index],
  projectOurCost: (index: number) => _projectOurCost[index],
  projectRentPrice: (index: number) => _projectRentPrice[index],
  projectDuration: (index: number) => _projectDuration[index],
  projectFormulaChosen: (index: number) => _projectFormulaChosen[index],
  ...
  description: (index: number) => _projectDescriptions[index],
  // Contact
