...
export const _projectDescriptions = [
...
export const _firstNames = ['Geoffray', 'Arnaud', 'Alexandre', 'Paul', 'Abdul', 'Hasan', 'Notaire'];

export const _lastNames = ['Atlan', 'Filhol', 'Schmitt', 'Chartier', 'Karim', 'Hasan', 'Notaire'];
...
export const _tags = ['T3', 'T2', 'Studio', 'T2', 'T2', 'T3', 'T3', 'Studio', 'T3', 'Studio'];
